...
date:         2024-4-12
author:       whiteicey
header-img:   img/optimized/hero/yolo.webp
catalog:      true
mathjax: true
tags:
    - Python
...
![yolov8](/img/optimized/body/yolov8.webp){: loading="lazy" decoding="async"}

![yolov3](/img/optimized/body/yolov3.webp){: loading="lazy" decoding="async"}
...
![need](/img/optimized/body/need.webp){: loading="lazy" decoding="async"}
...
![yolo](/img/optimized/body/yolo-intro.webp){: loading="lazy" decoding="async"}
...
![onnx](/img/optimized/body/onnx.webp){: loading="lazy" decoding="async"}

![onnx](/img/optimized/body/onnx-tiny.webp){: loading="lazy" decoding="async"}
...
![ncnn](/img/optimized/body/ncnnlogo.webp){: loading="lazy" decoding="async"}

![onnx](/img/optimized/body/ncnn-platform.webp){: loading="lazy" decoding="async"}
...
![pyqt](/img/optimized/body/pyqt.webp){: loading="lazy" decoding="async"}
...
>
>![yolov4](/img/optimized/body/yolov4.webp){: loading="lazy" decoding="async"}
>
>![yolov4](/img/optimized/body/yolov4-coco.webp){: loading="lazy" decoding="async"}
>
...
![Android](/img/optimized/body/andorid-flowchart.webp){: loading="lazy" decoding="async"}

第二版（视频实时识别+区域闯入）

![Android](/img/optimized/body/andorid-flowchart2.webp){: loading="lazy" decoding="async"}

PC端项目架构：

![PC](/img/optimized/body/pc-flowchart.webp){: loading="lazy" decoding="async"}
...
![Android](/img/optimized/body/yolo-android.webp){: loading="lazy" decoding="async"}

第二版（视频实时识别+区域闯入）

![Android](/img/optimized/body/yolo-android2.webp){: loading="lazy" decoding="async"}

PC端项目架构：

![PC](/img/optimized/body/yolo-pc.webp){: loading="lazy" decoding="async"}


# 使用Yolov5实现的detection效果图展示(初期效果图)

![resualt1](/img/optimized/body/imtest13.webp){: loading="lazy" decoding="async"}

![resualt2](/img/optimized/body/imtest14.webp){: loading="lazy" decoding="async"}

![resualt3](/img/optimized/body/imtest16.webp){: loading="lazy" decoding="async"}

![resualt4](/img/optimized/body/imtest17.webp){: loading="lazy" decoding="async"}
...
![Android](/img/optimized/body/android-login.webp){: loading="lazy" decoding="async"}

用户注册

![Android](/img/optimized/body/android-register.webp){: loading="lazy" decoding="async"}

功能总览

![Android](/img/optimized/body/android-functionshowcase.webp){: loading="lazy" decoding="async"}

拍照识别

![Android](/img/optimized/body/android-photoshoot.webp){: loading="lazy" decoding="async"}

读图识别

![Android](/img/optimized/body/android-readphoto.webp){: loading="lazy" decoding="async"}

第二版（视频实时识别+区域闯入）

目标识别

![Android](/img/optimized/body/android-realtime.webp){: loading="lazy" decoding="async"}

检测目标选择

![Android](/img/optimized/body/android-targetselect.webp){: loading="lazy" decoding="async"}

检测区域绘制

![Android](/img/optimized/body/android-areaselect.webp){: loading="lazy" decoding="async"}

区域内目标检测

![Android](/img/optimized/body/android-riskdiscern.webp){: loading="lazy" decoding="async"}

PC端项目架构：

图片识别

![pc](/img/optimized/body/pc-areaphotoidentification.webp){: loading="lazy" decoding="async"}

图片区域识别及报警

![pc](/img/optimized/body/pc-areaphotoalarm.webp){: loading="lazy" decoding="async"}

视频/摄像头识别与区域闯入检测

![pc](/img/optimized/body/pc-realtimeareaalarm1.webp){: loading="lazy" decoding="async"}


![pc](/img/optimized/body/pc-realtimeareaalarm2.webp){: loading="lazy" decoding="async"}
...
4. ~~关于明烟明火识别监测，吊装作业安全监测，动火作业监测目前还没有特别成熟的实现思路，暂时搁置~~  明烟明火识别目前看来是有成熟的识别方案的（见下图），吊装作业安全监测，动火作业监测依旧搁置
    ...
    ![fire](/img/optimized/body/fireidentify.webp){: loading="lazy" decoding="async"}
