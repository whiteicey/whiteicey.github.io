...
date:         2023-3-20
author:       whiteicey
header-img:   img/optimized/hero/stock.webp
catalog:      true
mathjax: true
tags:
    - Python
...
![approach_1](/img/optimized/body/approach1.webp){: loading="lazy" decoding="async"}

方案2

![approach_2](/img/optimized/body/approach2.webp){: loading="lazy" decoding="async"}
...
![](/img/optimized/body/finetune-fig2.webp "Linear schedule with layer-wise learning rate decay."){: loading="lazy" decoding="async"}
...
![](/img/optimized/body/finetune-fig3.webp "Linear schedule with grouped LLRD."){: loading="lazy" decoding="async"}
...
![](/img/optimized/body/finetune-fig4.webp "Linear schedule with LLRD and 50 warm-up steps."){: loading="lazy" decoding="async"}

下图显示了第50步的相应层的学习率。这些是我们为优化器设置的学习率。

![](/img/optimized/body/finetune-fig5.webp "Hover text reflects the learning rates at step-50. "){: loading="lazy" decoding="async"}
